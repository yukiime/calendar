...
import team.safe.InvaildQueryException;
...
class HandleParseLunar2Solar implements ActionListener {
  public void actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      int res[] = LunarSolar.lunarToSolar(year, month, lunarDate, isLeapMonth);
...
class HandleParseSolar2Lunar implements ActionListener {
  public void actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      int[] res = LunarSolar.solarToLunar(year, month, solarDate);
